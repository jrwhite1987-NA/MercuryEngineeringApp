========================================================================
    ACTIVE TEMPLATE LIBRARY : Audio Project Overview
========================================================================

AppWizard has created this Audio project for you to use as the starting point for
...
Audio.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Audio.h)
        GUID definitions                                (Audio_i.c)
        A type library                                  (Audio.tlb)
        Marshaling code                                 (Audio_p.c and dlldata.c)

Audio.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Audio.idl. It will be regenerated by MIDL during compilation.
...
Audiops.vcxproj
	...
	dlldata.c, Audio_i.c and Audio_p.c which are required
	to build the proxy/stub DLL.

Audiops.vcxproj.filters
